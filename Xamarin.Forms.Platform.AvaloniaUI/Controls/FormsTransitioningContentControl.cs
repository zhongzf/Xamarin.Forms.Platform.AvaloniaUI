...
namespace Xamarin.Forms.Platform.AvaloniaUI.Controls
{
	...
	public class FormsTransitioningContentControl : FormsContentControl
	{
		...
		//private Avalonia.Controls.ContentPresenter currentContentPresentationSite;
		//private Avalonia.Controls.ContentPresenter previousContentPresentationSite;
        ...
        public static readonly AvaloniaProperty IsTransitioningProperty;// = AvaloniaProperty.Register("IsTransitioning", typeof(bool), typeof(FormsTransitioningContentControl), new PropertyMetadata(OnIsTransitioningPropertyChanged));
        public static readonly AvaloniaProperty TransitionProperty;// = AvaloniaProperty.Register("Transition", typeof(TransitionType), typeof(FormsTransitioningContentControl), new FrameworkPropertyMetadata(TransitionType.Default, FrameworkPropertyMetadataOptions.AffectsArrange | FrameworkPropertyMetadataOptions.Inherits, OnTransitionPropertyChanged));
        public static readonly AvaloniaProperty RestartTransitionOnContentChangeProperty;// = AvaloniaProperty.Register("RestartTransitionOnContentChange", typeof(bool), typeof(FormsTransitioningContentControl), new PropertyMetadata(false, OnRestartTransitionOnContentChangePropertyChanged));
        public static readonly AvaloniaProperty CustomVisualStatesProperty;// = AvaloniaProperty.Register("CustomVisualStates", typeof(ObservableCollection<VisualState>), typeof(FormsTransitioningContentControl), new PropertyMetadata(null));
        public static readonly AvaloniaProperty CustomVisualStatesNameProperty;// = AvaloniaProperty.Register("CustomVisualStatesName", typeof(string), typeof(FormsTransitioningContentControl), new PropertyMetadata("CustomTransition"));
		...
		private static void OnIsTransitioningPropertyChanged(AvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
		{
		...
		private static void OnRestartTransitionOnContentChangePropertyChanged(AvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
		{
		...
		//	this.previousContentPresentationSite = this.GetTemplateChild(PreviousContentPresentationSitePartName) as Avalonia.Controls.ContentPresenter;
		//	this.currentContentPresentationSite = this.GetTemplateChild(CurrentContentPresentationSitePartName) as Avalonia.Controls.ContentPresenter;
		...
		//	}
		//	Avalonia.VisualStateManager.GoToState(this, NormalState, false);
		//}
		...
		private void StartTransition(object oldContent, object newContent)
		{
			...
			//		Avalonia.VisualStateManager.GoToState(this, NormalState, false);
			//		Avalonia.VisualStateManager.GoToState(this, this.GetTransitionName(this.Transition), true);
			//	}
			//}
		}
		...
		//{
		//	Avalonia.VisualStateGroup presentationGroup = VisualStates.TryGetVisualStateGroup(this, PresentationGroup);
		//	Storyboard newStoryboard = null;
		//	if (presentationGroup != null)
		//	{
		//		var transitionName = this.GetTransitionName(newTransition);
		//		newStoryboard = presentationGroup.States
		//										 .OfType<Avalonia.VisualState>()
