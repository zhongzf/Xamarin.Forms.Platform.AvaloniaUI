...
namespace Xamarin.Forms.Platform.AvaloniaUI.Controls
{
	public class FormsContentDialog : ContentControl, ILightContentDialog
	{
		...
		public static readonly AvaloniaProperty TitleProperty;// = AvaloniaProperty.Register("Title", typeof(object), typeof(FormsContentDialog));
        public static readonly AvaloniaProperty TitleTemplateProperty;// = AvaloniaProperty.Register("TitleTemplate", typeof(Avalonia.DataTemplate), typeof(FormsContentDialog));
        public static readonly AvaloniaProperty FullSizeDesiredProperty;// = AvaloniaProperty.Register("FullSizeDesired", typeof(bool), typeof(FormsContentDialog));
        public static readonly AvaloniaProperty IsPrimaryButtonEnabledProperty;// = AvaloniaProperty.Register("IsPrimaryButtonEnabled", typeof(bool), typeof(FormsContentDialog));
        public static readonly AvaloniaProperty IsSecondaryButtonEnabledProperty;// = AvaloniaProperty.Register("IsSecondaryButtonEnabled", typeof(bool), typeof(FormsContentDialog));
        public static readonly AvaloniaProperty PrimaryButtonCommandProperty;// = AvaloniaProperty.Register("PrimaryButtonCommand", typeof(ICommand), typeof(FormsContentDialog));
        public static readonly AvaloniaProperty SecondaryButtonCommandProperty;// = AvaloniaProperty.Register("SecondaryButtonCommand", typeof(ICommand), typeof(FormsContentDialog));
        public static readonly AvaloniaProperty PrimaryButtonTextProperty;// = AvaloniaProperty.Register("PrimaryButtonText", typeof(string), typeof(FormsContentDialog));
        public static readonly AvaloniaProperty PrimaryButtonCommandParameterProperty;// = AvaloniaProperty.Register("PrimaryButtonCommandParameter", typeof(object), typeof(FormsContentDialog));
        public static readonly AvaloniaProperty SecondaryButtonTextProperty;// = AvaloniaProperty.Register("SecondaryButtonText", typeof(string), typeof(FormsContentDialog));
        public static readonly AvaloniaProperty SecondaryButtonCommandParameterProperty;// = AvaloniaProperty.Register("SecondaryButtonCommandParameter", typeof(object), typeof(FormsContentDialog));
		...
		//public Avalonia.DataTemplate TitleTemplate
		//{
		//	get { return (Avalonia.DataTemplate)GetValue(TitleTemplateProperty); }
		...
		{
			if (Avalonia.Application.Current.MainWindow is FormsWindow window)
			{
		...
		private bool InternalHide(LightContentDialogResult contentDialogResult)
		{
			...
			if (!lightContentDialogClosingEventArgs.Cancel && Avalonia.Application.Current.MainWindow is FormsWindow window)
			{
	...
	internal interface ILightContentDialog
	{
		...
		//Avalonia.DataTemplate TitleTemplate { get; set; }
