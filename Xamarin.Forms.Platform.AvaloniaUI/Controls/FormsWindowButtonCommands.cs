...
namespace Xamarin.Forms.Platform.AvaloniaUI.Controls
{
	...
	{
		private Avalonia.Controls.Button min;
		private Avalonia.Controls.Button max;
		private Avalonia.Controls.Button close;
		...
		//	close = Template.FindName("PART_Close", this) as Avalonia.Controls.Button;
		//	if (close != null)
		//	{
		//		close.Click += CloseClick;
		//	}

		//	max = Template.FindName("PART_Max", this) as Avalonia.Controls.Button;
		//	if (max != null)
		//	{
		//		max.Click += MaximizeClick;
		//	}

		//	min = Template.FindName("PART_Min", this) as Avalonia.Controls.Button;
		//	if (min != null)
		//	{
