...
namespace Xamarin.Forms.Platform.AvaloniaUI
{
	...
	public class FormsTextBox : TextBox
	{
		...
		//public static readonly AvaloniaProperty PlaceholderTextProperty = AvaloniaProperty.Register("PlaceholderText", typeof(string), typeof(FormsTextBox),
		//	new PropertyMetadata(string.Empty));

		//public static readonly AvaloniaProperty PlaceholderForegroundBrushProperty = AvaloniaProperty.Register("PlaceholderForegroundBrush", typeof(Brush), typeof(FormsTextBox),
		//	new PropertyMetadata(default(Brush)));

		//public static readonly AvaloniaProperty IsPasswordProperty = AvaloniaProperty.Register("IsPassword", typeof(bool), typeof(FormsTextBox),
		//	new PropertyMetadata(default(bool), OnIsPasswordChanged));

		//public new static readonly AvaloniaProperty TextProperty = AvaloniaProperty.Register("Text", typeof(string), typeof(FormsTextBox), 
		//	new PropertyMetadata("", TextPropertyChanged));

		//protected internal static readonly AvaloniaProperty DisabledTextProperty = AvaloniaProperty.Register("DisabledText", typeof(string), typeof(FormsTextBox), 
		...
		static void OnIsPasswordChanged(AvaloniaObject AvaloniaObject, AvaloniaPropertyChangedEventArgs AvaloniaPropertyChangedEventArgs)
		{
			var textBox = (FormsTextBox)AvaloniaObject;
		...
		//void OnTextChanged(object sender, Avalonia.Controls.TextChangedEventArgs textChangedEventArgs)
		//{
		//	//if (IsPassword)
		//	//{
		//	//	string updatedRealText = DetermineTextFromPassword(Text, SelectionStart, base.Text);
		...
		//static void TextPropertyChanged(AvaloniaObject AvaloniaObject, AvaloniaPropertyChangedEventArgs AvaloniaPropertyChangedEventArgs)
		//{
		//	var textBox = (FormsTextBox)AvaloniaObject;
		//	textBox.SyncBaseText();
		//}
