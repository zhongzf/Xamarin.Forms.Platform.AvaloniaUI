	...
	public class MasterDetailPageRenderer : VisualPageRenderer<MasterDetailPage, FormsMasterDetailPage>
	{
		protected override void OnElementChanged(ElementChangedEventArgs<MasterDetailPage> e)
		{
			if (e.NewElement != null)
			{
				if (Control == null) // construct and SetNativeControl and suscribe control event
				{
					...
					//AvaloniaPropertyDescriptor.FromProperty(FormsMasterDetailPage.IsPresentedProperty, typeof(FormsMasterDetailPage)).AddValueChanged(Control, OnIsPresentedChanged);
				}
			}
		...
		protected override void Dispose(bool disposing)
		{
			...
			if (disposing)
			{
				if (Control != null)
				{
					//AvaloniaPropertyDescriptor.FromProperty(FormsMasterDetailPage.IsPresentedProperty, typeof(FormsMasterDetailPage))
